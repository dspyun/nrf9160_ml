...
void loop(void)
{
	...
	//TF_LITE_REPORT_ERROR(error_reporter, "acc read input:result %d:%d\n",input_length,got_data);
	/* If there was no new data, wait until next time. */
	if (!got_data) {
		TF_LITE_REPORT_ERROR(error_reporter, "acc no data %d\n",got_data);
		return;
	}
	...
	TF_LITE_REPORT_ERROR(error_reporter, "index %d\n",gesture_index);
	/* Produce an output */
